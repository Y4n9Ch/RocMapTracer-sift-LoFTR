...
DEFAULT_CONFIG = {
    ...
    # 小地图箭头检测参数
    "ARROW_HSV_LOW": [0, 0, 200],
    "ARROW_HSV_HIGH": [180, 50, 255],
    "ARROW_MIN_PIXELS": 30,
    "ARROW_SCREEN_ROTATION": 0
}
...
# 箭头检测专属
ARROW_HSV_LOW = settings.get("ARROW_HSV_LOW")
ARROW_HSV_HIGH = settings.get("ARROW_HSV_HIGH")
ARROW_MIN_PIXELS = settings.get("ARROW_MIN_PIXELS")
ARROW_SCREEN_ROTATION = settings.get("ARROW_SCREEN_ROTATION", 0)